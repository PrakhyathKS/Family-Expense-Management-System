...
public class Member_Expenses extends javax.swing.JFrame {

    public Member_Expenses() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel7.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 100, 210, 50));
        ...
        jButton6.setText("MANAGE EXPENSES");
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/expense.jpg"))); // NOI18N
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        Member_Expenses_Manage.main(null);
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
            Member_Expenses_View.main(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Member_Expenses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Member_Expenses().setVisible(true);
            }
        });
    }
