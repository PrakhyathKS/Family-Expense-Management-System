...
public class Member_Savings_View extends javax.swing.JFrame {
    Connection con;
    PreparedStatement pst;

    public Member_Savings_View() {
        initComponents();
...
public void table_update()
    {
        ...
        try{
            pst =con.prepareStatement("Select sid,type,amount,date from savings where User=?");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Member_Savings_View().setVisible(true);
        });
    }
