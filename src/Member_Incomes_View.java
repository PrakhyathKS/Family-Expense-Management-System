...
public class Member_Incomes_View extends javax.swing.JFrame {
    Connection con;
    PreparedStatement pst;

    public Member_Incomes_View() {
        initComponents();
...
public void table_update()
    {
        ...
        try{
            pst =con.prepareStatement("Select iid,type,amount,date from incomes where User=?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Member_Incomes_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }



        java.awt.EventQueue.invokeLater(() -> {
            new Member_Incomes_View().setVisible(true);
        });
    }
