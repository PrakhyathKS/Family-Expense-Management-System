...
public class Member_Expenses_View extends javax.swing.JFrame {
    Connection con;
    PreparedStatement pst;

    public Member_Expenses_View() {
        initComponents();
    ...
    private void initComponents() {
        ...
        ExpenseTable.setFocusCycleRoot(true);
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Member_Expenses_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }



        java.awt.EventQueue.invokeLater(() -> {
            new Member_Expenses_View().setVisible(true);
        });
    }
